...
import { ILesson, LessonData, LessonType } from '#T/lesson'
import { formatDate } from '#/tools/format-date'
import { MapWithDefaultValue } from '#/tools/map-with-def-value'
...
export const LessonTypeMap = new MapWithDefaultValue(
  [
...
export const LessonsTypeLocalIcon = new MapWithDefaultValue(
  [
...
export const LessonsTypeLocalRu = new MapWithDefaultValue(
  [
